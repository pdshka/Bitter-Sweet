...
public class GameData
{
    ...
    private void SetTeleporters()
    {
        ...
        teleporters.Add("2ecc4656-b196-420e-87ce-910543c7cafc", new Vector3(0.5f, 9f, 0f)); // Jungle-Temple
        teleporters.Add("5da5dfb1-abb4-45e6-9b73-7035e50bc49d", new Vector3(-0.5f, -8.5f, 0f)); // Temple-Jungle
        teleporters.Add("ea251a03-822a-4c40-92dd-3cea989fe827", new Vector3(-0.5f, 7.5f, 0f)); // Temple-Pipes
        teleporters.Add("edcf78b8-8005-4c43-bb60-5a78cc5fe010", new Vector3(-11.5f, 4.5f, 0f)); // Pipes-Temple
