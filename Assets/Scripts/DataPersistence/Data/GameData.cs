...
public class GameData
{
    ...
    private void SetTeleporters()
    {
        ...
        teleporters.Add("3017d9b7-2830-4b56-9ade-b29136b50dcc", new Vector3(7.5f, 0.4f, 0));//JungleSpawn-MoonCave
        teleporters.Add("742117c8-73c9-4bda-aa3a-1823f5719297", new Vector3(-10.5f, 0.7f, 0));//MoonCave-JungleSpawn
    }
}
